...
import com.asligresik.inventoryApp.async.AsyncTcpEscPosPrint;
import com.asligresik.inventoryApp.async.AsyncUsbEscPosPrint;
...
public class PrintLabelActivity extends BaseActivity {
    ...
    private final BroadcastReceiver usbReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (PrintLabelActivity.ACTION_USB_PERMISSION.equals(action)) {
                synchronized (this) {
