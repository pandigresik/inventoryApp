...
public class ReportRMIItemStockViewAdapter extends RecyclerView.Adapter {
    List<OutstandingRmiItem> items;
    List<OutstandingRmiItem> defaultitems;

    public ReportRMIItemStockViewAdapter(List<OutstandingRmiItem> items) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.outstanding_rmi_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            rowViewHolder.txtPartNameFg.setText("PartNameFG");
            rowViewHolder.txtQty.setText("Qty");
            rowViewHolder.txtQtyAct.setText("QtyAct");
            ...
            rowViewHolder.txtPartNameFg.setBackgroundResource(R.drawable.table_header_cell_bg);
            rowViewHolder.txtQty.setBackgroundResource(R.drawable.table_header_cell_bg);
            rowViewHolder.txtQtyAct.setBackgroundResource(R.drawable.table_header_cell_bg);
            ...
            rowViewHolder.txtPartNameFg.setText(modal.getNamefg() +"");
            rowViewHolder.txtQty.setText(String.valueOf(modal.getQty()) + "");
            rowViewHolder.txtQtyAct.setText(String.valueOf(modal.getQtyact()) + "");
            ...
            rowViewHolder.txtPartNameFg.setBackgroundResource(R.drawable.table_content_cell_bg);
            rowViewHolder.txtQty.setBackgroundResource(R.drawable.table_content_cell_bg);
            rowViewHolder.txtQtyAct.setBackgroundResource(R.drawable.table_content_cell_bg);
        }
    }
    ...
    public void setFilter(String characterText) {
        ...
        if (characterText.length() > 0) {
            for (OutstandingRmiItem item: defaultitems) {
                if (item.getNumber().toLowerCase(Locale.getDefault()).contains(characterText)) {
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView txtPartNameFg;
        protected TextView txtQty;
        protected TextView txtQtyAct;
        public RowViewHolder(View itemView) {
            ...
            txtPartNameFg = itemView.findViewById(R.id.txtPartNameFg);
            txtQty = itemView.findViewById(R.id.txtQty);
            txtQtyAct = itemView.findViewById(R.id.txtQtyAct);
