...
class ZKLib {
    ...
    public function __construct($ip = NULL, $port = NULL) {
        ...
        include_once("zklib/zkconst.php");
        include_once("zklib/zkconnect.php");
        include_once("zklib/zkversion.php");
        include_once("zklib/zkos.php");
        include_once("zklib/zkplatform.php");
        include_once("zklib/zkworkcode.php");
        include_once("zklib/zkssr.php");
        include_once("zklib/zkpin.php");
        include_once("zklib/zkface.php");
        include_once("zklib/zkserialnumber.php");
        include_once("zklib/zkdevice.php");
        include_once("zklib/zkuser.php");
        include_once("zklib/zkattendance.php");
        include_once("zklib/zktime.php");
    }
